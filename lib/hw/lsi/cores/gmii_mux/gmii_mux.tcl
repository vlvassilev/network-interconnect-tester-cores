...
#####################################
read_verilog "./hdl/gmii_mux_cpu_regs_defines.v"
read_verilog "./hdl/gmii_mux_cpu_regs.v"
read_verilog "./hdl/gmii_mux.v"
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1

#source gmii_mux_fifo.tcl
...
ipx::add_user_parameter {C_NUM_INPUTS} [ipx::current_core]
set_property value_resolve_type {user} [ipx::get_user_parameter C_NUM_INPUTS [ipx::current_core]]
set_property display_name {C_NUM_INPUTS} [ipx::get_user_parameter C_NUM_INPUTS [ipx::current_core]]
set_property value {32} [ipx::get_user_parameter C_NUM_INPUTS [ipx::current_core]]
set_property value_format {long} [ipx::get_user_parameter C_NUM_INPUTS [ipx::current_core]]
