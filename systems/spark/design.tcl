...
set_property -dict [list CONFIG.USE_DYN_RECONFIG {true} CONFIG.ENABLE_CLOCK_MONITOR {true} CONFIG.JITTER_SEL {Max_I_Jitter} CONFIG.PRIM_IN_FREQ {10.000} CONFIG.JITTER_OPTIONS {PS} CONFIG.CLKIN1_UI_JITTER {11000.000} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {10.000} CONFIG.ENABLE_USER_CLOCK0 {true} CONFIG.Enable_PLL0 {true} CONFIG.PRIMITIVE {MMCM} CONFIG.CLKIN2_UI_JITTER {100.000} CONFIG.CLKIN1_JITTER_PS {11000.000} CONFIG.CLKIN2_JITTER_PS {100.000} CONFIG.MMCM_BANDWIDTH {LOW} CONFIG.MMCM_CLKFBOUT_MULT_F {92.375} CONFIG.MMCM_CLKIN1_PERIOD {100.000} CONFIG.MMCM_CLKIN2_PERIOD {10.0} CONFIG.MMCM_REF_JITTER1 {0.110} CONFIG.MMCM_REF_JITTER2 {0.010} CONFIG.MMCM_CLKOUT0_DIVIDE_F {92.375} CONFIG.CLKOUT1_JITTER {5402.027} CONFIG.CLKOUT1_PHASE_ERROR {857.257} CONFIG.USER_CLK_FREQ0 {10.000}] [get_bd_cells clk_wiz_1]
...
# axi_gpio out: 0-loopback, 1-clk_wiz_0.clk_sel; in: 0-loopback, 1-clk_wiz_1.locked, 2-clk_wiz_0.locked 3-clk_wiz_2.locked, 4:6-clk_wiz_1.clk_stop, 7:9-clk_wiz_1.clk_glitch, 10:12-clk_wiz_1.clk_oor
...
set_property -dict [list CONFIG.NUM_PORTS {7}] [get_bd_cells axi_gpio_0_concat]
